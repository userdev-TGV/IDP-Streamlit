"""Prompt definitions shared between Streamlit UI and REST API."""
...
| **Дата окончания** | Дата завершения контркта                                             |
...
| **Data de Vigência** | Data de início de vigência                                          |
| **Data de Expiração** | Data de término                                                   |
| **Termos do Contrato** | Principais termos sobre duração e renovação                      |
| **Tática Promocional** | Principais estratégias promocionais                              |
| **Categoria de Produto** | Categorias de produtos incluídas                              |
| **Payment %**       | Percentuais de desconto/incentivos (detalhar tipos)                 |
| **Moeda**         | Moeda do contrato                                                   |
| **Detalhes de Incentivos** | Detalhes específicos dos incentivos/descontos              |
| **Exibição da Promoção** | Acordos de exposição em pontos de venda                      |
...
SYSTEM_PROMPT_DEFAULT = SYSTEM_PROMPT_ENGLISH
